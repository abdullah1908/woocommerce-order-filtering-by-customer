 ...
 * @subpackage Woocommerce_Order_Filtering_By_Customer/public
 * @author     Abdullah <abdullahmzm@gmail.com>
 */
class Woocommerce_Order_Filtering_By_Customer_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Woocommerce_Order_Filtering_By_Customer_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Woocommerce_Order_Filtering_By_Customer_Loader will then create the relationship
